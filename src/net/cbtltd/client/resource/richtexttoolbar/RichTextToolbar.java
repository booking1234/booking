package net.cbtltd.client.resource.richtexttoolbar;
...
/**
 * The Class RichTextToolbar is a sample tool bar for use with {@link RichTextArea}. It provides a simple UI
 * for all rich text formatting, dynamically displayed only for the available functionality.
 */
	...
	KeyUpHandler {
		...
		public void onClick(ClickEvent event) {
			...
			if (sender == bold) {
				...
				// We use the RichTextArea's onKeyUp event to update the tool bar status.
...
//		}
	...
	private EventListener handler = new EventListener();

	private RichTextArea richText;
	private RichTextArea.BasicFormatter formatter;
...
//		this.extended = richText.getExtendedFormatter();
	...
	private PushButton createPushButton(ImageResource img, String tip) {
		PushButton pb = new PushButton(img.getURL());
	...
	private ToggleButton createToggleButton(ImageResource img, String tip) {
		ToggleButton tb = new ToggleButton(img.getURL());
