...
public final class DefaultMonthSelector extends MonthSelector {
	...
	protected void setup() {
		...
		backwards.setStyleName(AbstractField.CSS.cbtDatePickerPreviousButton());

		forwards = new PushButton();
		forwards.getUpFace().setHTML("&raquo;");
		forwards.setStyleName(AbstractField.CSS.cbtDatePickerNextButton());
		...
		formatter.setStyleName(0, 1, AbstractField.CSS.cbtDatePickerMonth());
		formatter.setWidth(0, 0, "1");
		formatter.setWidth(0, 1, "100%");
		formatter.setWidth(0, 2, "1");
		grid.setStyleName(AbstractField.CSS.cbtDatePickerMonthSelector());
		initWidget(grid);
	}
