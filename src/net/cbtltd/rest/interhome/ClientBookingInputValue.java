...
public class ClientBookingInputValue {
	...
	public String toString() {
		...
		builder.append("ClientBookingInputValue [salesOfficeCode=");
		...
		builder.append(customerPhone);
		builder.append(", customerFax=");
		builder.append(customerFax);
		builder.append(", customerEmail=");
		builder.append(customerEmail);
		builder.append(", customerAddressStreet=");
		builder.append(customerAddressStreet);
		builder.append(", customerAddressAdditionalStreet=");
		builder.append(customerAddressAdditionalStreet);
		builder.append(", customerAddressZIP=");
		builder.append(customerAddressZIP);
		builder.append(", customerAddressPlace=");
		builder.append(customerAddressPlace);
		builder.append(", customerAddressState=");
		builder.append(customerAddressState);
		builder.append(", customerAddressCountryCode=");
		builder.append(customerAddressCountryCode);
