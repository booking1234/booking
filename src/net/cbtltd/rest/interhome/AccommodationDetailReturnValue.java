    ...
    extends ReturnValue
{
	...
	public String toString() {
		...
		builder.append("AccommodationDetailReturnValue [accommodationCode=");
		...
		builder.append(interior);
		builder.append(", tranquility=");
		builder.append(tranquility);
		builder.append(", kitchen=");
		builder.append(kitchen);
		builder.append(", accessRoad=");
		builder.append(accessRoad);
		builder.append(", pets=");
		builder.append(pets);
		builder.append(", cots=");
		builder.append(cots);
		builder.append(", additionBeds=");
		builder.append(additionBeds);
		builder.append(", parking=");
		builder.append(parking);
		builder.append(", tv=");
		builder.append(tv);
		builder.append(", dishwasher=");
		builder.append(dishwasher);
		builder.append(", washingmachine=");
		builder.append(washingmachine);
		builder.append(", aircondition=");
		builder.append(aircondition);
		builder.append(", pool=");
		builder.append(pool);
		builder.append(", tennis=");
		builder.append(tennis);
		...
		builder.append(geoLat);
		builder.append(", poolFrom=");
		builder.append(poolFrom);
		builder.append(", poolTo=");
		builder.append(poolTo);
		builder.append(", insideDescription=");
		builder.append(insideDescription);
		builder.append(", outsideDescription=");
		builder.append(outsideDescription);
