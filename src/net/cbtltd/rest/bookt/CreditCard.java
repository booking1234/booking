...
@XmlType(name = "CreditCard", namespace = "http://connect.bookt.com/Schemas/CreditCard.xsd", propOrder = {
    "address",
    "cardNumber",
    "city",
    "expiresOn",
...
public class CreditCard {
    ...
    @XmlElementRef(name = "Address", namespace = "http://connect.bookt.com/Schemas/CreditCard.xsd", type = JAXBElement.class)
    protected JAXBElement<String> address;
    @XmlElementRef(name = "CardNumber", namespace = "http://connect.bookt.com/Schemas/CreditCard.xsd", type = JAXBElement.class)
    protected JAXBElement<String> cardNumber;
    @XmlElementRef(name = "City", namespace = "http://connect.bookt.com/Schemas/CreditCard.xsd", type = JAXBElement.class)
    protected JAXBElement<String> city;
    @XmlElement(name = "ExpiresOn")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar expiresOn;
    @XmlElementRef(name = "NameOnCard", namespace = "http://connect.bookt.com/Schemas/CreditCard.xsd", type = JAXBElement.class)
    protected JAXBElement<String> nameOnCard;
    @XmlElementRef(name = "PostalCode", namespace = "http://connect.bookt.com/Schemas/CreditCard.xsd", type = JAXBElement.class)
    protected JAXBElement<String> postalCode;
    @XmlElementRef(name = "SecurityCode", namespace = "http://connect.bookt.com/Schemas/CreditCard.xsd", type = JAXBElement.class)
    protected JAXBElement<String> securityCode;
    @XmlElementRef(name = "State", namespace = "http://connect.bookt.com/Schemas/CreditCard.xsd", type = JAXBElement.class)
    protected JAXBElement<String> state;
    @XmlElementRef(name = "Type", namespace = "http://connect.bookt.com/Schemas/CreditCard.xsd", type = JAXBElement.class)
