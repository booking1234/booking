 ...
 *                   &lt;/simpleType>
 *                 &lt;/attribute>
 *                 &lt;attribute name="totalInventoryAvailable" use="required">
 *                   &lt;simpleType>
 *                     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}int">
 *                       &lt;minInclusive value="0"/>
 *                       &lt;maxInclusive value="4999"/>
 ...
 *                   &lt;/simpleType>
 *                 &lt;/attribute>
 *                 &lt;attribute name="totalInventorySold" use="required" type="{http://www.w3.org/2001/XMLSchema}nonNegativeInteger" />
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
 ...
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;extension base="{http://www.expediaconnect.com/EQC/PAR/2013/07}RatePlanType">
 *               &lt;/extension>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
...
public class RoomTypeType {
    ...
    public static class Inventory {
        ...
        @XmlAttribute
        protected Integer baseAllocation;
        @XmlAttribute
        protected Integer flexibleAllocation;
        @XmlAttribute(required = true)
        protected int totalInventoryAvailable;
        @XmlAttribute(required = true)
        @XmlSchemaType(name = "nonNegativeInteger")
        protected BigInteger totalInventorySold;

        /**
         * Gets the value of the baseAllocation property.
         * 
         * @return
         *     possible object is
         *     {@link Integer }
         *     
         */
        public Integer getBaseAllocation() {
            return baseAllocation;
        }

        /**
         * Sets the value of the baseAllocation property.
         * 
         * @param value
         *     allowed object is
         *     {@link Integer }
         *     
         */
        public void setBaseAllocation(Integer value) {
            this.baseAllocation = value;
        }
         ...
         * 
         */
        public int getTotalInventoryAvailable() {
         ...
         * 
         */
        public void setTotalInventoryAvailable(int value) {
            this.totalInventoryAvailable = value;
        }

        /**
         * Gets the value of the totalInventorySold property.
         * 
         * @return
         *     possible object is
         *     {@link BigInteger }
         *     
         */
        public BigInteger getTotalInventorySold() {
            return totalInventorySold;
        }

        /**
         * Sets the value of the totalInventorySold property.
         * 
         * @param value
         *     allowed object is
         *     {@link BigInteger }
         *     
         */
        public void setTotalInventorySold(BigInteger value) {
            this.totalInventorySold = value;
        }
