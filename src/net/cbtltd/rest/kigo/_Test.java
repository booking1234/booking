...
public final class _Test implements Handleable {
	...
	public static void main(String args[]) throws Exception {
		LOG.error("Kigo Started");
		SqlSession sqlSession = RazorServer.openSession();
		try {
			String altpartyid = "100293"; //Test data
//			String altpartyid = "102017"; //Les Studios de Paris email: api@lesstudiosdeparis.com password: password
			String reservationid = ""; //Les Studios de Paris reservation
...
//			sqlSession.commit();
		...
		LOG.error("Kigo Terminated");
		System.exit(0);
	}

	private A_Handler getHandler() {
		SqlSession sqlSession = RazorServer.openSession();
		String altpartyid = "100293";
		Partner partner = sqlSession.getMapper(PartnerMapper.class).exists(altpartyid);
		if (partner == null) {throw new ServiceException(Error.party_id, altpartyid);}
		A_Handler handler = new A_Handler(partner);
		return handler;
