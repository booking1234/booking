 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="detail" type="{}activity-detail" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
public class Activity {
    ...
    protected Activity.Details details;
     ...
     *     
     */
    public Activity.Details getDetails() {
        return details;
    }
     ...
     *     
     */
    public void setDetails(Activity.Details value) {
        this.details = value;
    }
    ...
    public static class Details {
        ...
        @XmlElement(required = true)
        protected List<ActivityDetail> detail;
        ...
        public List<ActivityDetail> getDetail() {
            if (detail == null) {
                detail = new ArrayList<ActivityDetail>();
            }
            return this.detail;
        }
