...
public class MaryHttpClient extends MaryClient {
	...
	private static final Logger LOG = Logger.getLogger(MaryHttpClient.class.getName());
...
/*    private String getFromServer(String key) throws IOException
  ...
  */  
            ...
            boolean streamingAudio, String outputTypeParams) throws IOException
    {
        ...
        LOG.debug("URL " + data.hostAddress.getHttpAddress()+"/process" + "\nparams " + params);
        
        //to make HTTP Post request with HttpURLConnection
        URL url = new URL(data.hostAddress.getHttpAddress()+"/process");
//        URL url = new URL(data.hostAddress.getHttpAddress()+"/process?" + params.toString());
