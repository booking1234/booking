...
public class PayHandler implements Handler {
	...
	public JSONResponse execute(HashMap<String, String> parameters) {
		...
		try {
			...
			Element element = PaygateHandler.getXML(eventname, cardholder, cardnumber, cardmonth + cardyear, value, Currency.Code.ZAR.name(), cardcode, emailaddress, remote_host);
